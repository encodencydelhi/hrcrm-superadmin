                            ...
                            <div className="border-t border-slate-100 pt-2 grid grid-cols-2 gap-y-4 gap-x-8">
                                <div className="space-y-5">
                                    ...
                                    <div className="grid grid-cols-[120px_1fr] items-start gap-2">
                                        ...
                                        <span className="text-[12px] font-medium text-slate-700 truncate">{w.website || '—'}</span>
                                    </div>
                                </div>
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-zinc-200 p-2 flex flex-col h-full">
                            ...
                            <div className="border-t border-slate-100 pt-2 grid grid-cols-1 lg:grid-cols-2 gap-y-4 gap-x-6">
                                <div className="grid grid-cols-[auto_minmax(0,1fr)] gap-x-4 gap-y-2 items-start">
                                    ...
                                    <span className="text-[11px] font-medium text-[#3b82f6] truncate">{w.adminEmail || '—'}</span>
                                ...
                                <div className="grid grid-cols-[auto_minmax(0,1fr)] gap-x-4 gap-y-2 items-start">
                                    ...
                                    <span className="text-[11px] font-medium text-[#3b82f6] truncate">{w.email || '—'}</span>
                                    ...
                                    <span className="text-[11px] font-medium text-[#3b82f6] truncate">{w.supportEmail || '—'}</span>
                                    ...
                                    <span className="text-[11px] font-medium text-[#3b82f6] truncate">{w.website || '—'}</span>
                                </div>
                            </div>
                        </div>
