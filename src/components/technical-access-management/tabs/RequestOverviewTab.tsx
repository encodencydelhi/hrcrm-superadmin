  ...
  return (
    <div className={`flex items-center ${GAP}`}>
      ...
      <div className="flex justify-between w-full">
        <span className="text-[10px] flex-1 text-gray-500">{label}</span>
      ...
      <div className={`bg-white ${CARD_BORDER} ${CARD_RADIUS} ${CARD_PAD}`}>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className={`flex items-start ${GAP}`}>
            ...
            <div className="flex justify-between w-full">
              <span className="text-[10px] flex-1 text-gray-500">
          ...
          <div className={`flex items-start ${GAP}`}>
            ...
            <div className="flex justify-between w-full">
              <p className="text-[10px] flex-1 text-gray-500">Contact</p>
              <div className="flex-1">
      ...
      <div className={`bg-white ${CARD_BORDER} ${CARD_RADIUS} ${CARD_PAD}`}>
        ...
        <div className="mb-2 flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[10px] text-gray-500">TechVision Pvt. Ltd.</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex-1">
            ...
            <p className="text-[10px] text-gray-500">IT Head</p>
            <p className="text-[10px] text-gray-500">TechVision Pvt. Ltd.</p>
          </div>
              ...
              <div key={item.step} className="relative flex gap-2 pb-2 last:pb-0">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-col justify-between gap-0.5 sm:flex-row sm:items-start">
                    ...
                    <span className="ml-1 text-[10px] text-gray-400">{item.time}</span>
                  </div>
                </div>
              </div>
            );
      ...
      >
        ...
        <div className={`grid grid-cols-1 ${GAP} sm:grid-cols-2`}>
          ...
          >
            ...
            <button className="flex h-7 w-7 shrink-0 items-center justify-center rounded-md border border-gray-200 text-gray-500 hover:bg-gray-50">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-[10px] text-gray-500">XLSX · 245 KB</p>
              </div>
            </div>
            <button className="flex h-7 w-7 shrink-0 items-center justify-center rounded-md border border-gray-200 text-gray-500 hover:bg-gray-50">
              <FileDown className="h-3.5 w-3.5" />
