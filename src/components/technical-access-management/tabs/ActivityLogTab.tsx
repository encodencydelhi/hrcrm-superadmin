...
import {
    ChevronRight, Info, Download, ArrowLeft, ArrowRight,
    FileText, Calendar, LogIn, LayoutGrid, Eye, Settings, FileDown, LogOut,
    ShieldCheck,
} from "lucide-react";
...
const ACTIVITY_LOGS: ActivityLog[] = [
    {
        id: 1, date: "30 May 2025", time: "02:36 PM", user: "Rahul Verma", role: "Sr. Support Engineer",
        userAvatar: "/avatars/rahul.jpg", actionTitle: "Login", actionDesc: "Successful login",
        actionColor: "text-emerald-500", actionDot: "bg-emerald-500", moduleTitle: "System", moduleDesc: "Login Module",
        ipAddress: "203.110.245.25", location: "Noida, India", details: "User logged in using provided credentials",
        icon: <LogIn size={14} className="text-emerald-500" />, iconBg: "bg-emerald-50", iconBorder: "border-emerald-200",
    },
    {
        id: 2, date: "30 May 2025", time: "02:37 PM", user: "Rahul Verma", role: "Sr. Support Engineer",
        userAvatar: "/avatars/rahul.jpg", actionTitle: "Module Accessed", actionDesc: "View",
        actionColor: "text-blue-500", actionDot: "bg-blue-500", moduleTitle: "Employee Master", moduleDesc: "View Employees",
        ipAddress: "203.110.245.25", location: "Noida, India", details: "Viewed 25 employee records",
        icon: <LayoutGrid size={14} className="text-purple-500" />, iconBg: "bg-purple-50", iconBorder: "border-purple-200",
    },
    {
        id: 3, date: "30 May 2025", time: "02:42 PM", user: "Amit Kumar", role: "System Engineer",
        userAvatar: "/avatars/amit.jpg", actionTitle: "Data Viewed", actionDesc: "Read",
        actionColor: "text-amber-500", actionDot: "bg-amber-500", moduleTitle: "Payroll", moduleDesc: "Salary Components",
        ipAddress: "203.110.245.26", location: "Noida, India", details: "Viewed salary component configuration",
        icon: <Eye size={14} className="text-amber-500" />, iconBg: "bg-amber-50", iconBorder: "border-amber-200",
    },
    {
        id: 4, date: "30 May 2025", time: "03:15 PM", user: "Rahul Verma", role: "Sr. Support Engineer",
        userAvatar: "/avatars/rahul.jpg", actionTitle: "Configuration Updated", actionDesc: "Update",
        actionColor: "text-emerald-500", actionDot: "bg-emerald-500", moduleTitle: "System Settings", moduleDesc: "General Settings",
        ipAddress: "203.110.245.25", location: "Noida, India", details: "Updated date format settings",
        icon: <Settings size={14} className="text-emerald-500" />, iconBg: "bg-emerald-50", iconBorder: "border-emerald-200",
    },
    {
        id: 5, date: "30 May 2025", time: "04:10 PM", user: "Neha Singh", role: "Database Specialist",
        userAvatar: "/avatars/neha.jpg", actionTitle: "Report Generated", actionDesc: "Export",
        actionColor: "text-blue-500", actionDot: "bg-blue-500", moduleTitle: "Reports & Analytics", moduleDesc: "Leave Report",
        ipAddress: "203.110.245.27", location: "Noida, India", details: "Exported leave report (Excel)",
        icon: <FileDown size={14} className="text-blue-500" />, iconBg: "bg-blue-50", iconBorder: "border-blue-200",
    },
    {
        id: 6, date: "30 May 2025", time: "04:28 PM", user: "Rahul Verma", role: "Sr. Support Engineer",
        userAvatar: "/avatars/rahul.jpg", actionTitle: "Logout", actionDesc: "Session Ended",
        actionColor: "text-red-500", actionDot: "bg-red-500", moduleTitle: "System", moduleDesc: "Logout Module",
        ipAddress: "203.110.245.25", location: "Noida, India", details: "User logged out successfully",
        icon: <LogOut size={14} className="text-red-500" />, iconBg: "bg-red-50", iconBorder: "border-red-200",
    },
];

function ActivityLogTable() {
    const columns: TableCardColumn<ActivityLog>[] = [
        {
            key: "datetime",
            header: "Date & Time",
            render: (log) => (
            ...
            render: (log) => (
                <div className="flex items-center gap-2">
                    <div className="h-6 w-6 rounded-full bg-zinc-200 overflow-hidden shrink-0 border border-zinc-300">
                        <img
                            src={`https://ui-avatars.com/api/?name=${encodeURIComponent(log.user)}&background=random&color=fff&size=24`}
                            alt={log.user}
    ...
    return (
        <TableCard
            ...
            description="Track all actions performed by the Crewcam technical team."
            fullHeight
            headerActions={
                <>
...
function InfoAlert() {
    return (
        <div className="rounded-lg bg-[#fffbeb] border border-[#fde68a] p-3 flex items-start gap-2.5 shadow-sm mt-2">
